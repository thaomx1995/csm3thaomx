...
! function(e) {
    ...
    return r.widget("ui.slider", r.ui.mouse, {
        ...
        _createHandles: function() {
            ...
            for (i.length > a && (i.slice(a).remove(), i = i.slice(0, a)), e = i.length; e < a; e++) s.push("<span class='ui-slider-handle ui-state-default ui-corner-all' tabindex='0'></span>");
            this.handles = i.add(r(s.join("")).appendTo(this.element)), this.handle = this.handles.eq(0), this.handles.each(function(e) {
        ...
        _mouseCapture: function(e) {
            ...
            return !o.disabled && (this.elementSize = {
                ...
                (t < s || s === t && (e === l._lastChangedValue || l.values(e) === o.min)) && (s = t, a = r(this), n = e)
            }), !1 !== this._start(e, n) && (this._mouseSliding = !0, this._handleIndex = n, a.addClass("ui-state-active").focus(), t = a.offset(), h = !r(e.target).parents().addBack().is(".ui-slider-handle"), this._clickOffset = h ? {
                left: 0,
                top: 0
            } : {
        ...
        _slide: function(e, t, i) {
            var s, a;
            this.options.values && this.options.values.length ? (s = this.values(t ? 0 : 1), (i = 2 === this.options.values.length && !0 === this.options.range && (0 === t && s < i || 1 === t && i < s) ? s : i) !== this.values(t) && ((a = this.values())[t] = i, a = this._trigger("slide", e, {
                handle: this.handles[t],
                value: i,
                values: a
        ...
        _refreshValue: function() {
            ...
            }) : (e = this.value(), s = this._valueMin(), a = this._valueMax(), u["horizontal" === this.orientation ? "left" : "bottom"] = (i = a !== s ? (e - s) / (a - s) * 100 : 0) + "%", this.handle.stop(1, 1)[o ? "animate" : "css"](u, h.animate), "min" === n && "horizontal" === this.orientation && this.range.stop(1, 1)[o ? "animate" : "css"]({
                width: i + "%"
